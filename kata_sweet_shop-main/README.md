...
<img width="678" height="655" alt="image" src="https://github.com/user-attachments/assets/de3536cb-66c7-47b2-9873-5164e2430058" />



<img width="945" height="664" alt="image" src="https://github.com/user-attachments/assets/8108846e-1200-4028-a3c6-5ef9fdff1caa" />
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/notkumarMohit Thakur/Kata_sweet_shop.git](https://github.com/notkumarMohit Thakur/Kata_sweet_shop.git)
    cd Kata_sweet_shop
    ```
...
npm test -- --coverage
```
Test Report: KATA Sweet Shop Backend API
...
screenshot:<img width="1276" height="647" alt="Screenshot 2025-09-20 181745" src="https://github.com/user-attachments/assets/29ed0984-459c-4daf-b25a-06c8cc6f6495" />


Summary
All configured test suites for the backend API passed successfully. The tests cover core business logic for the SweetService (database operations) and the AuthService (user authentication endpoints), confirming that the API is functioning as expected.

Test Suite Results
✓ src/tests/sweetService.test.js

Status: PASSED

Tests: 4 passed (Covers creating, updating, deleting, and purchasing sweets).

✓ src/tests/auth.test.js

Status: PASSED

Tests: 3 passed (Covers user registration, successful login, and failed login).

Code Coverage
The following is a summary of the code coverage report generated by Vitest.
...
Conclusion
The backend API has been successfully tested against its core requirements. The results indicate high confidence in the stability and correctness of the authentication and inventory management logic.
